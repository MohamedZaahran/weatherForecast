...
<style>
@import url(https://f...content-available-to-author-only...s.com/css?family=Montserrat);
@import url(https://f...content-available-to-author-only...s.com/css?family=Advent+Pro:400,200);
*{margin: 0;padding: 0;}
 
body {
 background-image: url(https://w...content-available-to-author-only...u.org/wp-content/uploads/lightning_sky_trees_outlines_stars_bad_weather_night_orange_birds_64059_1920x1080.jpg );
...
<div class="widget"> 
  ...
  <div style="text-align: center;"><a href="Weather Station Report" style="align:center">Weather Report Station</a></div>
  <div class="lower">    
    <ul class="infos">
      <li class="info temp">
...
function drawClock(){
    ...
    xhttp.onreadystatechange = function() {
      ...
      var obj = JSON.parse(txt); //Ref: https://w...content-available-to-author-only...s.com/js/js_json_parse.asp
